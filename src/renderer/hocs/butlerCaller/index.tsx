...
interface GenericProps<Params, Result> {
  params: Params;
  render: (args: ButlerCallerArgs<Params, Result>) => React.ReactElement;
...
export function renderNoop(): React.ReactElement {
  return null;
}
...
const butlerCaller = <Params, Result>(
  ...
  class Wrapper extends React.PureComponent<Props, State> {
    ...
    static renderCallback(
      f: (args: ButlerCallerArgs<Params, Result>) => React.ReactElement
    ) {
      return f;
    }
